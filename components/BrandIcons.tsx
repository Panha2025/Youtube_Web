...
export function YouTubeLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      ...
      />
      <path fill="#fff" d="M9.6 15.6V8.4L15.9 12l-6.3 3.6Z" />
    </svg>
  );
}
...
export function FacebookLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      ...
      <path
        fill="#fff"
        d="M15.1 13.1h-2.2V21H9.6v-7.9H8v-2.8h1.6V8.5c0-2.4 1.4-3.7 3.6-3.7 1 0 2.1.2 2.1.2v2.3h-1.2c-1.2 0-1.5.7-1.5 1.5v1.8h2.6l-.1 2.5Z"
      />
    </svg>
  );
}
